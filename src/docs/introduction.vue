<template>
	<div class="mx-auto w-full flex-1 max-w-screen-md">
		<header class="space-y-2">
			...
			<p class="text-muted-foreground text-[1.05rem] sm:text-base">Basecoat is a set of components built with Tailwind
				CSS. It is designed to be used with any traditional web stack</p>
		</header>
		<article class="pb-12 mt-8 content">
			<h2 id="why"><a href="#why">Why Basecoat?</a></h2>
			<div class="prose">
				<p><b>Basecoat brings the magic of <a href="https://ui.shadcn.com/">shadcn/ui</a> to any traditional web stack:
						no React required.</b></p>

				<p>Tailwind won. But building UIs with utility classes alone kinda sucks. Most Tailwind libraries like Flowbite,
					Preline, or even Tailwind UI ask you to copy walls of unreadable classes into your HTML. It works, but it's
					messy and hard to maintain.</p>

				<p>shadcn/ui avoids that by wrapping everything in React components. It also gives you a killer design system,
					theme support, a CLI, and a growing ecosystem.</p>

				<p>But maybe you're not using React. Maybe your app is built with plain HTML. Or Flask. Or Rails. Or Laravel. Or
					Django. Or whatever.</p>

				<p><b>That's where Basecoat comes in.</b> It gives you modern, accessible components with the simplicity of
					plain HTML and Tailwind. Basecoat is:</p>

				<ul>
					<li><b>Lightweight</b>: no runtime JS, just CSS and a tiny bit of vanilla JavaScript for the more interactive
						components.</li>
